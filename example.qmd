...
Input to the CAMDA calculator are 'region_size' (the size of the CpG-centered region for the CAMDA score)
and 'max_read_length' (the longest expected read length).

```{python}
region_size = 1 ## calculate concurrence for individual CpG sites
max_read_length = 250
camdacalculator = CAMDACalculator(region_size,max_read_length,extractor)
